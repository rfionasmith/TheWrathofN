...
#ex2 = np.logical_and(distance>100,distance<=200)
...
for i in range(1,6):
    ...
    if i < 4:
        ...
        plt.semilogx(data.iloc[:,i+4],values,'.r',markersize=1,alpha=0.7)
        ...
        plt.semilogx(data.iloc[:,i+5],values,'.r',markersize=1,alpha=0.7)
